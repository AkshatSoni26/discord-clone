...
import { Edit, FileIcon, FilesIcon, ShieldAlert, ShieldCheck, Trash } from "lucide-react";
        ...
        <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full">
            <div className="group flex gap-x-2 items-start w-full">
                <div
                    ...
                    className="flex  cursor-pointer hover:drop-shadow-md transition">
                    <UserAvatar
                        ...
                        }
                        {
                            !fileUrl && !isEditing && (
                                <p className={cn(
                                    ...
                                    deleted && "italic text-zinc-600 dark:text-zinc-400 text-xs mt-1"
                                )}>
                                    {content}
                                    {isUpdated && !deleted && (
